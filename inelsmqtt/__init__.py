...
class InelsMqtt:
    ...
    def is_subscribed(self, topic) -> dict[str, bool]:
    ...
    def last_values(self, topic) -> dict[str, str]:
        """List of all last values in all subscribed topics

        Returns:
            dict[str, str]: list of all inels last values
        """
